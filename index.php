...
<header class="bgimg-1 w3-display-container w3-grayscale-min" id="home">
  <div class="w3-display-left w3-text-white" style="padding:48px">
    <span class="w3-jumbo w3-hide-small">Welcome to our Page</span><br>
    <span class="w3-xxlarge w3-hide-large w3-hide-medium">Welcome to our Page</span><br><br>
    ...
    <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-card">
        ...
        <div class="w3-container">
          ...
          <p class="w3-opacity">Good For 2 Persons <br> Capacity up to <?php echo $rooms['RoomCapacity']?> persons</p>
