...
.crumb li a:hover:after { border-left-color: #dfab21;   !important; }
	...
	<div class="row">
		<ul class="crumb">
			<li class="completed"><a href="Modifyroomdate.php">Select Dates</a></li>
			<li class="active"><a href="javascript:void(0);">Select Rooms</a></li>
			<li><a href="javascript:void(0);">Guest Information</a></li>
