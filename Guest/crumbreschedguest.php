...
.crumb li a:hover:after { border-left-color: #dfab21;   !important; }
	...
	<div class="row">
		<ul class="crumb">
			<li class="completed"><a href="rescheduledate.php">Select Dates</a></li>
			<li class="completed"><a href="reschedroom.php">Select Rooms</a></li>
			<li class="active"><a href="javascript:void(0);">Reservation Information</a></li>
