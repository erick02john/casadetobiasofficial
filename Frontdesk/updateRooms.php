...
$description = $_POST['description'];
	$update = mysqli_query($conn, "UPDATE roomtype SET RoomRate = '$roomrate', RoomCapacity = '$roomcapacity', Description = '$description' WHERE RoomType = '$roomtype'") or die ("no connection update");
		mysqli_close($conn);
