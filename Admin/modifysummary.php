...
$addsD = 0;
    ...
    $query2 = mysqli_query($conn, "SELECT * FROM guest WHERE GuestId = '$guestID'");
...
input[type="radio"]:checked + label span {
    ...
    <center><h2>Modify Reservation Summary</h2></center>
                        ...
                        <div class="modal-dialog modal-sm">
                            <div class="modal-content">
                                <div class="modal-body">
                                    ...
                                    <h4 align="center"><i class="glyphicon glyphicon-question-sign"></i>&nbsp; Upon confirmation, the bank details will be sent on your account.<br /><br /> Confirm Reservation? </h4>
                                </div>
                                <div class="modal-footer">
                                    <form method="post" action="modifyreservation.php" name="submitval" id="submitval" class="once">
