...
<html lang="en">
  <head>
    ...
    <title>Modify - Select Rooms</title>
...
<div class="wrap">
  ...
  <div class="container">
      ...
      <form method="POST" action="Modifyroom.php">
        <table class="tablecon">
          <tr>
            ...
            <img style="width: 180px; height: 130px;" src="upload/<?php echo $rmsp['RoomPhoto']?>" alt="Presidential(Queen Sized-Bed)" />
        ...
        <td><div class="roombox">
          <div class="alert alert-info" style="background-color: #002366; color: #fff;">
            ...
            <img style="width: 180px; height: 130px;" src="upload/<?php echo $rmdp['RoomPhoto']?>" alt="Presidential(Twin Sized-Bed)" />
            <br><font size="2">(Airconditioned room)
            <br />(for 2 persons)
        ...
        <td><div class="roombox">
          ...
          <img style="width: 180px; height: 130px;" src="upload/<?php echo $rmss['RoomPhoto']?>" alt="Superior(Queen Sized-Bed)" />
            <br><font size="2">(Airconditioned room)
            <br />(for 2 persons)
        ...
        <td><div class="roombox">
          ...
          <img style="width: 180px; height: 130px;" src="upload/<?php echo $rmds['RoomPhoto']?>" alt="Superior(Twin Sized-Bed)" />
            <br><font size="2">(Airconditioned room)
            <br />(for 2 persons)
