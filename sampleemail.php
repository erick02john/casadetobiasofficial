														...
														<td align='center' valign='top' class='textContent'>
                                                                    <div  style='text-align:left;font-family:Helvetica, Arial, sans-serif;font-size:15px;margin-right: 10; margin-left:10;margin-bottom:0;margin-top:10px;color:#5F5F5F;line-height:135%;'>
																		...
																		<table  cellpadding='1' cellspacing='0' style='font-size: 17px;' width='100%'>
																			<tr>
																				<td width='40%'>Date of Booking: </td><td width='60%'>fullname</td>
																			</tr>
																			<tr>
																				<td width='40%'>Check-in Date: </td><td width='60%'>ttlgst</td>
																			</tr>
																			<tr>
																				<td width='40%'>Check-out Date: </td><td width='60%'>inres</td>
																			</tr>
																			<tr>
                                                                        ...
                                                                        <table  cellpadding='1' cellspacing='0' style='font-size: 17px;' width='100%'>
                                                                            <tr>
                                                                                <td width='40%'>Guest Name: </td><td width='60%'> </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td width='40%'>Guest Email: </td><td width='60%'> </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td width='40%'>Guest Phone: </td><td width='60%'> </td>
                                                                            </tr>
                                                                        </table><br>
                                                                        <table  cellpadding='1' cellspacing='0' style='font-size: 17px;' width='100%'>
                                                                            <tr>
                                                                                <td width='40%'>Room: </td><td width='60%'> </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td width='40%'>Number of rooms reserved: </td><td width='60%'> </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td width='40%'>Breakfast No. of PAX: </td><td width='60%'> </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td width='40%'>Inclusive of use of pool for: </td><td width='60%'> </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td width='40%'>Total Amount: </td><td width='60%'><b> </b></td>
                                                                            </tr>
																		</table><br><br>
																		<table  cellpadding='1' cellspacing='0' style='font-size: 17px;' width='100%'>
                                                                            <tr>
                                            ...
                                            <table border='0' cellpadding='0' cellspacing='0' width='600' class='flexibleContainer'><tbody><tr><td align='center' valign='top' width='600' class='flexibleContainerCell'>
                                                        <table border='0' cellpadding='40' cellspacing='0' width='100%'><tbody><tr><td valign='top' bgcolor='#E1E1E1'>
                                                                    <div style='font-family:Helvetica, Arial, sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;'>
                                                                        <div>Copyright © 2018 <span style='color:#828282;'>Casa de Tobias Mountain Resort's Resort</span></a>. All&nbsp;rights&nbsp;reserved.</div>
                                                                    </div>
                                                                </td>
                                                            </tr></tbody></table></td>
                                                </tr></tbody></table></td>
